...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GM] = LAYOUT( /* GM layer */
    ...
    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                   KC_1,     KC_2, KC_3, KC_4, KC_5     ,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                   KC_GRAVE, KC_Q, KC_W, KC_E, KC_R     ,
    TO(_QW), KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC,  KC_TAB, KC_F, KC_SPACE, KC_A, KC_S, KC_D, KC_V
};
