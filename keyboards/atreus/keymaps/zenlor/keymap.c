...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GB] = LAYOUT( /* [> GAMING B <] */
    KC_INS,  KC_HOME, KC_UP,   KC_END,  KC_PGUP,                  KC_9,   KC_F4,   KC_5,  KC_6,  KC_7  ,
    KC_DELT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                  KC_0,   KC_F1,   KC_F2, KC_F3, KC_8  ,
    KC_NO,   KC_VOLU, KC_NO,   KC_NO,   KC_B,                     KC_GRV, KC_Q,    KC_W,  KC_E,  KC_MINS  ,
    TO(_QW), KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_TAB, KC_SPC, KC_TRNS, KC_S,  KC_V,  KC_F ),
};
