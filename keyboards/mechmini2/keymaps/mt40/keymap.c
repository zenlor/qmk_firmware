...
#define C_LALT MT(MOD_LGUI, KC_LEAD)
#define C_RALT MT(MOD_RGUI, KC_LEAD)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = KEYMAP_2U_SPACE_ORTHO(
        ...
        KC_TAB,  KC_A,   KC_S,   KC_D,  KC_F,  KC_G,   KC_H,   KC_J,  KC_K,    KC_L,   KC_SCLN, C_ENT,   \
        KC_LSPO, KC_Z,   KC_X,   KC_C,  KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, \
        C_LCTL,  C_LGUI, C_LALT, MO(3), MO(1),      KC_SPC,    MO(2), MO(4),   C_RALT, C_RGUI,  C_RCTL),

/* ,-----------------------------------------------------------------------------------.
 * |      |  F9  |  F10 |  F11 |  F12 |      |      |  7   |  8   |  9   |  /   | DEL  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  F5  |  F6  |  F7  |  F8  |      |      |  4   |  5   |  6   |  *   |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 ...
 */
    [1] = KEYMAP_2U_SPACE_ORTHO(
        _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  RGB_TOG, RGB_MOD, KC_P7, KC_P8,   KC_P9,   KC_PSLS, KC_DEL, \
