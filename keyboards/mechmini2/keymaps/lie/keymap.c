...
#define KEYMAP KEYMAP_2U_SPACE_ORTHO
...
[_RAISE] = {
    ...
    { KC_GRV,  KC_PERC, KC_AMPR, KC_ASTR, KC_UNDS, KC_LBRC, KC_RBRC, KC_UNDS, KC_ASTR, KC_AMPR, KC_PERC, KC_GRAV }
...
[_NAV] = {
    ...
    { KC_ACL1, KC_BTN1, KC_MS_U, KC_BTN2, ______, RGB_VAD, RGB_VAI, KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT, KC_COPY  },
